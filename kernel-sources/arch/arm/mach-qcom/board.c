...
static const char * const tiefighter_dt_match[] __initconst = {
	"meraki,tiefighter",
	NULL
};

DT_MACHINE_START(TIEFIGHTER, "Meraki TIE Fighter")
	.dt_compat = tiefighter_dt_match,
	.restart = insect_wdt_restart,
MACHINE_END

static const char * const xwing_dt_match[] __initconst = {
    "meraki,x-wing",
    NULL
};

DT_MACHINE_START(XWING, "Meraki X-wing")
    .dt_compat = xwing_dt_match,
    .restart = insect_wdt_restart,
MACHINE_END

static const char * const fairyfly_dt_match[] __initconst = {
	"meraki,fairyfly",
	NULL
};

DT_MACHINE_START(FAIRYFLY, "Meraki Fairyfly")
	.dt_compat = fairyfly_dt_match,
	.restart = insect_wdt_restart,
MACHINE_END

static const char * const fuzzy_cricket_dt_match[] __initconst = {
	"meraki,fuzzy cricket",
	NULL
};

DT_MACHINE_START(FUZZY_CRICKET, "Meraki Fuzzy Cricket")
	.dt_compat = fuzzy_cricket_dt_match,
	.restart = insect_wdt_restart,
MACHINE_END

static const char * const hog_dt_match[] __initconst = {
	"meraki,heart of gold",
	NULL
};

DT_MACHINE_START(HOG, "Meraki Heart of Gold")
	.dt_compat = hog_dt_match,
	.restart = insect_wdt_restart,
MACHINE_END
